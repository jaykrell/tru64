 ...
 * HISTORY
 * $Log: mfapi.h,v $
 * Revision 1.1.2.1  2006/07/18  11:15:27  Sunilkumar_Mummigatti
 * 	New for sendmail.v8.13.6
 *
 * $EndLog$
 */
/*
 * @(#)$RCSfile: mfapi.h,v $ $Revision: 1.1.2.1 $ (DEC) $Date: 2006/07/18 11:15:27 $
 */
/*
 ...
 *
 *
 *	$Id: mfapi.h,v 1.1.2.1 2006/07/18 11:15:27 Sunilkumar_Mummigatti Exp $
 */
