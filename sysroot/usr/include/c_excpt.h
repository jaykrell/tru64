...
#ifdef _INCLUDE_ID
#pragma ident "$Header: /share/buffer/build/rcs.dsk1/os/src/usr/include/alpha/c_excpt.h,v 1.1.12.2 1997/05/29 19:37:58 Neil_Lewis Exp $"
#endif
...
#ifdef __DECC
long  __exception_code(void);
#define exception_code() __exception_code()
Exception_info_ptr __exception_info(void);
