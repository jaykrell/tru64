 ...
 * Motif Release 1.2.1
*/ 
/*   $RCSfile: UilSymDef.h,v $ $Revision: 1.1.4.2 $ $Date: 1993/05/07 00:39:43 $ */
...
/*
**      Auxiliary sym_k_flags for values stored in b_arg_type field
**      Used in Compound Strings and Nested Compound Strings
*/
#define sym_k_unspecified_cs    0
#define sym_k_nested_cs         1
       /* This is a nested compound string value          */
