 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /share/buffer/build/rcs.dsk1/os/src/usr/include/ar.h,v 4.2.10.2 1997/05/29 19:37:54 Neil_Lewis Exp $ */
...
#if defined(__vax) || defined(__u3b) || defined(_M32) || defined(__u3b15) \
 || defined(__u3b5) || defined(__u3b2) || defined(__mc68000) || \
...
{
	char	ar_name[16];	/* file member name - blank terminated */
	char	ar_date[12];	/* file member date - decimal */
	char	ar_uid[6];	/* file member user id - decimal */
	char	ar_gid[6];	/* file member group id - decimal */
	char	ar_mode[8];	/* file member mode - octal */
	char	ar_size[10];	/* file member size - decimal */
	char	ar_fmag[2];	/* (ARFMAG | ARFZMAG) - string to end header */
};
