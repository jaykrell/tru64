 ...
 */
/*	
 *	@(#)$RCSfile: dumprestor.h,v $ $Revision: 4.2.10.3 $ (DEC) $Date: 1999/04/13 16:22:43 $
 */ 
/*
 */
/*
...
/*
 * COMPONENT_NAME: archival commands (CMDARCH)
 *                                                                    
 * ORIGIN: BSD, ATT, IBM
 *
...
struct 	icommon
{
	...
	nlink_t	ic_nlink;	/*  2: number of links to file */
