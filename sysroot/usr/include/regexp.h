 ...
 */
/*	
 *	@(#)$RCSfile: regexp.h,v $ $Revision: 4.2.11.2 $ (DEC) $Date: 1998/06/17 20:21:55 $
 */ 
/*
...
extern char	*__mbsadvance __((const char *));
...
#endif	/* _REENTRANT || _THREAD_SAFE */
{
	...
	switch (__status) {
	  ...
	  case _ABNORMAL:
	    __save = __pattern;
	    while (*__save != '{') {
		__save = (char *)__mbsadvance(__save);
		if (!__save) {
		    ERROR(_ABNORMAL);
		}
	    }
...
#endif	/* _REENTRANT || _THREAD_SAFE */
{
    ...
    } while ((__p1 = (char *)__mbsadvance(__p1)));
