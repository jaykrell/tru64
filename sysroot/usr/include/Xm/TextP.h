...
*/ 
/*   $RCSfile: TextP.h,v $ $Revision: 1.1.17.1 $ $Date: 2002/01/14 18:31:08 $ */
/*
...
#ifdef DEC_I18N_MOTIF_EXTENSION
    Boolean reconnectable;	  /* Determines if text is reconnectable */
#endif /* DEC_I18N_MOTIF_EXTENSION */
...
extern void _XmTextEnableRedisplay() ;
         ...
         */
extern int _XmTextCountSpacingChar();
