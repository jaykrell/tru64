 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: TextFP.h,v $ $Revision: 1.1.17.1 $ $Date: 2002/01/14 18:31:06 $ */
/*
...
typedef struct _XmTextFieldPart
  {
    ...
    Boolean reconnectable;	/* Sets reconnectablility of text */
...
#define TextF_Editable(tfg)			(((XmTextFieldWidget)(tfg)) -> \
					   text.editable)
#ifdef DEC_I18N_MOTIF_EXTENSION
#define TextF_Reconnectable(tfg)           	(((XmTextFieldWidget)(tfg)) -> \
                                           text.reconnectable)
#endif /*DEC_I18N_MOTIF_EXTENSION */
