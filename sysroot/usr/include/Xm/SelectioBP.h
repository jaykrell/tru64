 ...
 * Motif Release 1.2.3
*/ 
/*   $RCSfile: SelectioBP.h,v $ $Revision: 1.1.12.2 $ $Date: 1994/09/09 21:23:45 $ */
/*
...
#define _XmSelectionBoxCreateSelectionLabel	_XmSelectionBoxCreateSelectionL
#define _XmSelectionBoxCreateApplyButton	_XmSelectionBoxCreateApplyButto
#define _XmSelectionBoxCreateCancelButton	_XmSelectionBoxCreateCancelButt
#define _XmSelectionBoxGetSelectionLabelString	_XmSelectionBoxGetSelectionLabe
#define _XmSelectionBoxGetListLabelString	_XmSelectionBoxGetListLabelStri
#define _XmSelectionBoxGetListVisibleItemCount	_XmSelectionBoxGetListVisibleIt
#define _XmSelectionBoxGetApplyLabelString	_XmSelectionBoxGetApplyLabelStr
#define _XmSelectionBoxGetCancelLabelString	_XmSelectionBoxGetCancelLabelSt
#define _XmSelectionBoxGetHelpLabelString	_XmSelectionBoxGetHelpLabelStri
#endif
