...
*/ 
/*   $RCSfile: XmP.h,v $ $Revision: 1.1.14.6 $ $Date: 1997/05/16 05:05:40 $ */
/*
...
#define LayoutP(w)              (((XmPrimitiveWidget) w)->primitive.dxm_layout_direction)
#define LayoutG(w)              (((XmGadget) w)->gadget.dxm_layout_direction)
#define LayoutM(w)              (((XmManagerWidget) w)->manager.dxm_layout_direction)
#define LayoutIsRtoLP(w)        (LayoutP(w) == DXmLAYOUT_LEFT_DOWN)
#define LayoutIsRtoLG(w)        (LayoutG(w) == DXmLAYOUT_LEFT_DOWN)
#define LayoutIsRtoLM(w)        (LayoutM(w) == DXmLAYOUT_LEFT_DOWN)
...
#ifndef XmConst
#if ((defined(__STDC__) && __STDC__) || (FUNCPROTO&4))  ||  !defined( NO_CONST )
...
enum{	XmCASCADE_BUTTON_BIT = 1,	XmCASCADE_BUTTON_GADGET_BIT,
	...
	XmDROP_TRANSFER_BIT,		
          /* 28 is available */
	XmDROP_SITE_MANAGER_BIT, /* This is 29. */
...
#ifndef OSF_v1_2_4
#ifdef ALPHA_BUG_FIX
/* alpha port note: despite the name of the macro, the intended recipient
    of the data created by the macros that use this define is Cardinal
    (at least as far as I could tell in code & documentation)
    As sizeof(Cardinal) may be less that of sizeof(long) as it is
    on Alpha, the correct type useage is important. The name probably
 ...
 *
 *
 * VMS compiler produces errors with the continuation symbol '\'
 *
 * The fix is to get rid of the continuation line and this line
 *  for Unix systems too.
 * 
 */

#if defined(FUNCPROTO) || defined(__STDC__) && __STDC__ && !defined(UNIXCPP) || defined(__cplusplus)

/* 
 * This can't compile on VMS because of the continuation line.
 *
 * #if defined(FUNCPROTO) \
 *
 *  || defined(__STDC__) && __STDC__ && 
 *
 *  !defined(UNIXCPP) || defined(__cplusplus)
 */

#ifndef OSF_v1_2_4
# define XmPartOffset(part, variable) \
        ((part##Index) << XmHALFLONGBITS) + XtOffsetOf( part##Part, variable)
#else /* OSF_v1_2_4 */
# define XmPartOffset(part, variable) \
...
#define _XmPrimitiveTopShadowPixmapDefault  _XmPrimitiveTopShadowPixmapDefa
#define _XmManagerTopShadowPixmapDefault    _XmManagerTopShadowPixmapDefaul
#define	_XmPrimitiveHighlightPixmapDefault  _XmPrimitiveHighlightPixmapDefa
#define	_XmManagerHighlightPixmapDefault    _XmManagerHighlightPixmapDefaul
#define	_XmGetDefaultThresholdsForScreen    _XmGetDefaultThresholdsForScree
#define _XmGetDefaultBackgroundColorSpec    _XmGetDefaultBackgroundColorSpc
#define _XmSetDefaultBackgroundColorSpec    _XmSetDefaultBackgroundColorSpc
#ifdef DEC_MOTIF_EXTENSION
#define _DXmCvtStringToFitToScreenPolicy _DXmCvtStringToFitToScreenPolic
#endif
#endif
...
#ifdef DEC_ISE_BUG_FIX
        /* 
         * ISE merge fix (March 1994)
         * OSF QAR number: 18817
         * Fixed by: Ivan Yim
         *
         * Provide correct off-the-spot area for XIM input servers
         */
extern XtGeometryResult _XmImQueryGeometry() ;
#endif /* DEC_ISE_BUG_FIX */
...
#if defined(VMS) || defined (__VMS)
/* VMS limit of 31 characters in extern function names */
#define	_XmRegionIntersectRectWithRegion    _XmRegionIntersectRectWithRegio
#endif
...
#ifdef DEC_MOTIF_EXTENSION
#define DXmDefaultFont  "-*-Menu-Medium-R-Normal--*-120-*-*-P-*-ISO8859-1"
