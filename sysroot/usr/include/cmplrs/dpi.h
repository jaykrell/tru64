 ...
 * HISTORY
 */
/*   "@(#)$RCSfile: dpi.h,v $ $Revision: 1.1.19.2 $ (DEC) $Date: 1997/10/10 17:19:47 $";
*/
/*
 * $Header: /share/buffer/build/rcs.dsk1/os/src/usr/include/cmplrs/dpi.h,v 1.1.19.2 1997/10/10 17:19:47 Peter_Thompson Exp $
 */
/* 
 * *****************************************************************
 * *                                                               *
...
typedef struct _dpi_info	*dpi_info;	/* general info for process */
typedef struct _dpi		*dpi;		/* function vector */
...
struct _dpi {
    ...
    dpi_state   (*test_state)(          /* get snapshot vs cache of state */
		    dpi                 dpi,
		    dpi_address         *address);
