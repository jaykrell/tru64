 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /share/buffer/build/rcs.dsk1/os/src/usr/include/cmplrs/f_errno.h,v 4.2.8.2 1998/08/12 17:34:02 Neil_Lewis Exp $ */
/*
 *
 * f77 I/O error definitions
 */

#ifndef _CMPLRS_F_ERRNO_H_
#define _CMPLRS_F_ERRNO_H_
#ifdef __cplusplus
extern "C" {
#endif
