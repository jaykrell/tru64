 ...
 */
/*
 *      @(#)$RCSfile: mount.h,v $ $Revision: 4.2.5.4 $ (DEC) $Date: 1994/03/29 18:42:47 $
 */
/*
 */
...
#ifndef _RPCSVC_MOUNT_H_
#define _RPCSVC_MOUNT_H_
...
_BEGIN_CPLUSPLUS
bool_t xdr_path __((XDR *, char **));
bool_t xdr_fhandle __((XDR *, fhandle_t *));
bool_t xdr_fhstatus __((XDR *, struct fhstatus *));
bool_t xdr_mountlist __((XDR *, struct mountlist **));
bool_t xdr_exports __((XDR *, struct exports **));
_END_CPLUSPLUS

#endif /* _RPCSVC_MOUNT_H_ */
