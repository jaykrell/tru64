 ...
 */
/*	
 *	@(#)$RCSfile: ether.h,v $ $Revision: 4.2.3.2 $ (DEC) $Date: 1994/03/29 18:41:51 $
 */ 
/*
 */
/*
...
_BEGIN_CPLUSPLUS
int xdr_etherstat __((XDR *, struct etherstat *));
int xdr_etherhbody __((XDR *, struct etherhmem *));
int xdr_etherhmem __((XDR *, struct etherhmem **));
int xdr_etherhtable __((XDR *, struct etherhmem **));
int xdr_etheraddrs __((XDR *, struct etheraddrs *));
int xdr_addrmask __((XDR *, struct addrmask *));
_END_CPLUSPLUS
