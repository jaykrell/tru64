 ...
 */
/*
 * @(#)$RCSfile: cssmapi.h,v $ $Revision: 1.1.2.8 $ (DEC) $Date: 2001/11/02 21:47:06 $
 */
/*-----------------------------------------------------------------------
 * File: CSSMAPI.H
 *
...
CSSM_RETURN CSSMAPI CSSM_Unintroduce(
                        const CSSM_GUID *ModuleID );
...
/************************************************************************/
/*** Cryptographic Service Provider APIs ********************************/
/************************************************************************/

/* Cryptographic Context API; CSSM core only */
...
/* APIs that have corresponding SPIs */
...
CSSM_RETURN CSSMAPI CSSM_AC_AuthCompute(
...
CSSM_RETURN CSSMAPI CSSM_KR_RecoveryRequest(
									...
									const CSSM_CRYPTO_DATA *UserCallback,
									uint32 *EstimatedTime,
									const CSSM_HANDLE *ReferenceHandle );
...
CSSM_RETURN CSSMAPI CSSM_KR_GetRecoveredObject(
									...
									CSSM_CSP_HANDLE CSPHandle,
									const CSSM_CRYPTO_DATA *PassPhrase,
...
CSSM_RETURN CSSMAPI CSSM_KR_PassThrough(
									...
									CSSM_CC_HANDLE CryptoContext,
									uint32 PassThroughId,
									const CSSM_DATA *InputParams,
									CSSM_DATA_PTR Output);
