 ...
 */
/*
 * @(#)$RCSfile: oidsattr.h,v $ $Revision: 1.1.2.6 $ (DEC) $Date: 2001/11/02 21:48:14 $
 */
/*-----------------------------------------------------------------------
 * File: OIDSATTR.H
 *
...
CSSMOID_CollectiveFacsimileTelephoneNumber= {OID_ATTR_TYPE_LENGTH+2, OID_CollectiveFacsimileTelephoneNumber},
