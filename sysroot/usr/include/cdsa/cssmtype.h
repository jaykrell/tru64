 ...
 */
/*
 * @(#)$RCSfile: cssmtype.h,v $ $Revision: 1.1.2.7 $ (DEC) $Date: 2002/03/20 21:54:37 $
 */
/*-----------------------------------------------------------------------
 * File: CSSMTYPE.H
 *
...
/*
    ...
    This structure is used to provide input parameters to key derivation
    algorithms based on SSL3 Master key derivation.
*/
...
}CSSM_SSL3_MASTER_KEY_DERIVE_PARAMS, *CSSM_SSL3_MASTER_KEY_DERIVE_PARAMS_PTR;

/*
    CSSM_SSL3_KEY_AND_MAC_DERIVE_PARAMS
    This structure is used during phase 2 of SSL3 Key derivation.
*/
...
}CSSM_SSL3_KEY_AND_MAC_DERIVE_PARAMS, *CSSM_SSL3_KEY_AND_MAC_DERIVE_PARAMS_PTR;
