...
void XEPrintEvtStats P((FILE *ofp , XETrapGetStatsRep *pstats , XETC *tc));
void XEPrintReqStats P((FILE *ofp , XETrapGetStatsRep *pstats , XETC *tc));
...
void XEPrintStatistics P((FILE *ofp , XETrapGetStatsRep *pstats, XETC *tc ));

/* XEStrMap.c */
INT16 XEEventStringToID P((char *string ));
INT16 XERequestStringToID P((char *string ));
CARD32 XEPlatformStringToID P((char *string ));
char *XEEventIDToString P((CARD8 id , XETC *tc));
char *XERequestIDToExtString P((register CARD8 id , XETC *tc));
char *XERequestIDToString P((CARD8 id , XETC *tc));
