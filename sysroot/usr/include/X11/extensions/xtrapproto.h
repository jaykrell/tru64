...
#endif
/* xtrapdi.c */
int XETrapDestroyEnv P((pointer value , XID id ));
void XETrapCloseDown P(( ExtensionEntry *extEntry ));
...
void XETSwCreateWindow P((xCreateWindowReq *data , ClientPtr client ));
void XETSwChangeWindowAttributes P((xChangeWindowAttributesReq *data , ClientPtr client ));
void XETSwReparentWindow P((xReparentWindowReq *data ));
void XETSwConfigureWindow P((xConfigureWindowReq *data  , ClientPtr client ));
...
void XETSwCreateGC P((xCreateGCReq *data , ClientPtr client ));
void XETSwChangeGC P((xChangeGCReq *data , ClientPtr client ));
void XETSwCopyGC P((xCopyGCReq *data ));
void XETSwSetDashes P((xSetDashesReq *data ));
void XETSwSetClipRectangles P((xSetClipRectanglesReq *data , ClientPtr client ));
...
void XETSwPoly P((xPolyPointReq *data , ClientPtr client ));
void XETSwFillPoly P((xFillPolyReq *data , ClientPtr client ));
...
void XETSwFreeColors P((xFreeColorsReq *data , ClientPtr client ));
void XETSwStoreColors P((xStoreColorsReq *data , ClientPtr client ));
void XETSwStoreNamedColor P((xStoreNamedColorReq *data ));
void XETSwQueryColors P((xQueryColorsReq *data , ClientPtr client ));
...
void XETSwChangeKeyboardControl P((xChangeKeyboardControlReq *data , ClientPtr client ));
...
void XETSwRotateProperties P((xRotatePropertiesReq *data , ClientPtr client ));
