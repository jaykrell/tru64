 ...
 */
/*
 *	@(#)$RCSfile: svc.h,v $ $Revision: 4.2.15.4 $ (DEC) $Date: 1996/12/09 22:12:07 $
 */
/*
 */
...
_BEGIN_CPLUSPLUS
extern bool_t	svc_register __((SVCXPRT*, u_int, u_int, void (*) (struct svc_req *, SVCXPRT *), int));
...
extern void	svc_unregister __((u_int, u_int));
...
extern void	svcerr_progvers __((SVCXPRT*, u_int, u_int));
...
extern SVCXPRT *svcudp_bufcreate __((int, u_int, u_int));
