 ...
 */
/*	
 *	@(#)$RCSfile: locale.h,v $ $Revision: 4.2.10.2 $ (DEC) $Date: 1994/05/16 18:15:58 $
 */ 
/*
...
#ifdef _OSF_SOURCE
#define __left_parenthesis	left_parenthesis
#define __right_parenthesis	right_parenthesis
#endif /* _OSF_SOURCE */
