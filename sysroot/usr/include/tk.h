...
#define TK_RELIEF_FLATLINE	6        /* Added flatline relief */
                                         /* Changed for sysman.   */
...
#ifndef	NO_DEC_I18N
/*
 * TK_CHECK_IC is just the reverse of TK_CHECKED_IC.
 * Input context will only be created if this flag is set.
 * This limits the creation of IC to only certain widgets like Text 
 * and Entry instead of all the widgets.
 */
#undef	TK_CHECKED_IC
#define	TK_CHECK_IC		0x20
#endif

/*
 *--------------------------------------------------------------
