...
#define LDBL_EPSILON       1.9259299443872358530559779425849273185e-34L
#define LDBL_DIG           33
#define LDBL_MIN_EXP       -16381
#define LDBL_MIN           3.3621031431120935062626778173217526026e-4932L
#define LDBL_MIN_10_EXP    -4931
#define LDBL_MAX_EXP       16384
#define LDBL_MAX           1.1897314953572317650857593266280070162e+4932L
...
#if	__X_FLOAT
extern  unsigned   int LDINFINITY[4];
extern  unsigned   int LDQNAN[4];
extern  unsigned   int LDSNAN[4];
#endif	/* __X_FLOAT == 1 */
#endif
...
#if	__X_FLOAT
#define LDBL_INFINITY (*((long double *) (LDINFINITY)))
#define LDBL_QNAN (*((long double *) (LDQNAN)))
#define LDBL_SNAN (*((long double *) (LDSNAN)))
#else	/* __X_FLOAT == 1 */
...
extern unsigned int read_rnd();
extern unsigned int write_rnd();
#else   /* _NO_PROTO */
...
{
#endif
extern unsigned int read_rnd(void);
extern unsigned int write_rnd(unsigned int);
#if defined(__cplusplus)
}
#endif
...
/*
** ccg:  use fp_class.h for these definitions.  Retain the old math.h
**       definitions in case somebody relies on them.
*/
#include <fp_class.h>
