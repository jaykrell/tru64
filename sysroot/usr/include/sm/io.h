 ...
 * HISTORY
 * $Log: io.h,v $
 * Revision 1.1.2.1  2006/07/18  11:15:49  Sunilkumar_Mummigatti
 * 	New for sendmail.v8.13.6
 *
 * $EndLog$
 */
/*
 * @(#)$RCSfile: io.h,v $ $Revision: 1.1.2.1 $ (DEC) $Date: 2006/07/18 11:15:49 $
 */
/*
 ...
 *
 *	$Id: io.h,v 1.1.2.1 2006/07/18 11:15:49 Sunilkumar_Mummigatti Exp $
 */
