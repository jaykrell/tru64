 ...
 * HISTORY
 * $Log: string.h,v $
 * Revision 1.1.2.1  2006/07/18  11:16:12  Sunilkumar_Mummigatti
 * 	New for sendmail.v8.13.6
 *
 * $EndLog$
 */
/*
 * @(#)$RCSfile: string.h,v $ $Revision: 1.1.2.1 $ (DEC) $Date: 2006/07/18 11:16:12 $
 */
/*
 ...
 *
 *	$Id: string.h,v 1.1.2.1 2006/07/18 11:16:12 Sunilkumar_Mummigatti Exp $
 */
