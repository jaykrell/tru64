 ...
 * HISTORY
 * $Log: heap.h,v $
 * Revision 1.1.2.1  2006/07/18  11:15:48  Sunilkumar_Mummigatti
 * 	New for sendmail.v8.13.6
 *
 * $EndLog$
 */
/*
 * @(#)$RCSfile: heap.h,v $ $Revision: 1.1.2.1 $ (DEC) $Date: 2006/07/18 11:15:48 $
 */
/*
 ...
 *
 *	$Id: heap.h,v 1.1.2.1 2006/07/18 11:15:48 Sunilkumar_Mummigatti Exp $
 */
