 ...
 * HISTORY
 * $Log: conf.h,v $
 * Revision 1.1.2.1  2006/07/18  11:15:42  Sunilkumar_Mummigatti
 * 	New for sendmail.v8.13.6
 *
 * $EndLog$
 */
/*
 * @(#)$RCSfile: conf.h,v $ $Revision: 1.1.2.1 $ (DEC) $Date: 2006/07/18 11:15:42 $
 */
/*
 ...
 *
 *
 *	$Id: conf.h,v 1.1.2.1 2006/07/18 11:15:42 Sunilkumar_Mummigatti Exp $
 */
...
#  define GIDSET_T	gid_t
#  define SM_INT32	int	/* 32bit integer */
#ifdef DEC_EXTENSIONS
#  include <standards.h>

#define HASFLOCK      0               /* use fcntl/nfs locking */
#define SFS_TYPE      SFS_MOUNT       /* use stat fns that work across NFS impl */

#define _PATH_SENDMAILPID     "/var/run/sendmail.pid"

/* sendmail.cf and  submit.cf locations found via /etc/mail symbolic link */
/* */
#define _PATH_VENDOR_CF       "/var/adm/sendmail/sendmail.cf"
#define _DIR_SENDMAILCF      "/var/adm/sendmail/"
/*  */

/*  dont need this if open ldap is included */
/*
#ifndef LDAP_AUTH_KRBV4
#define LDAP_AUTH_KRBV4 0xffL
#endif
*/
#else
#  ifndef HASFLOCK
