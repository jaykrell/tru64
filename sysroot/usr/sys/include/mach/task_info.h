 ...
 */
/*	
 *	@(#)$RCSfile: task_info.h,v $ $Revision: 4.2.13.3 $ (DEC) $Date: 1997/01/17 21:44:48 $
 */ 
/*
 */
/*
...
struct task_basic_info {
	...
	vm_size_t	virtual_size;	/* virtual address space size (bytes) */
	vm_size_t	resident_size;	/* resident set size (bytes) */
