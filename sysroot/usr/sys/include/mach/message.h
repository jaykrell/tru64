 ...
 */
/*	
 *	@(#)$RCSfile: message.h,v $ $Revision: 4.3.11.5 $ (DEC) $Date: 1997/10/09 22:28:09 $
 */ 
/*
 */
/*
...
/*	MSG_TYPE_INTERNAL_MEMORY 14	obsolete */
/*	Until MIG & netmsgserver are updated, use integer type, see also
 *	std_types.defs XXXX
...
#ifdef _KERNEL
msg_return_t	msg_rpc_from_kernel(
	msg_header_t	*header,	/* in/out */
	msg_option_t	option,
	msg_size_t	rcv_size,
	msg_timeout_t	send_timeout,
