...
/* Routine bind_thread_to_cpu */
mig_external kern_return_t bind_thread_to_cpu
#if	defined(LINTLIBRARY)
    (target_task, target_thread, cpu_mask, flag)
	task_t target_task;
	thread_t target_thread;
	long cpu_mask;
	long flag;
{ return bind_thread_to_cpu(target_task, target_thread, cpu_mask, flag); }
#else
#if	(defined(__STDC__) || defined(c_plusplus))
(
	task_t target_task,
...
/* Routine bind_thread_to_cpu_id */
mig_external kern_return_t bind_thread_to_cpu_id
#if	defined(LINTLIBRARY)
    (target_task, target_thread, cpu_id, flag)
	task_t target_task;
	thread_t target_thread;
	long cpu_id;
	long flag;
{ return bind_thread_to_cpu_id(target_task, target_thread, cpu_id, flag); }
#else
#if	(defined(__STDC__) || defined(c_plusplus))
(
	task_t target_task,
