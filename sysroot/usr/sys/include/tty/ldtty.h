 ...
 */
/*
 * @(#)$RCSfile: ldtty.h,v $ $Revision: 1.1.17.2 $ (DEC) $Date: 1997/01/28 22:50:00 $
 */
/*
 ...
 */
#define LDTTY_STREAMS_HIWAT		4096
...
#define TS_STOPDRAIN	0x00100000	/* Give up drain in close - signal rec'd */
...
int
ldtty_configure(cfg_op_t, caddr_t, ulong, caddr_t, ulong);
...
PRIVATE_STATIC int
ldtty_need_flush(unsigned int, struct ldtty *, struct termios *);
