 ...
 */
/*
 *		@(#)$RCSfile: dli_var.h,v $ $Revision: 4.4.9.4 $ (DEC) $Date: 1994/05/12 18:01:10 $
 *
...
#define NO_PROTOID	{ 0x00, 0x00, 0x00, 0x00, 0x00 }
...
#ifdef _KERNEL /* the following should not be used by applications */
