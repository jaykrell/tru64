 ...
 */
/*
 * @(#)$RCSfile: localedef.h,v $ $Revision: 1.1.20.4 $ (DEC) $Date: 1996/12/23 15:54:21 $
 */
/*
 ...
 */
typedef struct {
  int (*getcolval) __((_LC_collate_t *, unsigned int *, unsigned int, const char *, int));
} _LC_coll_methods_t;
...
#define _ISMACRO(c,cmsk) ((_METHOD(__lc_ctype,iswctype) == 0L) \
		? (int) (__lc_ctype->_mask[c] & (cmsk)) \
		: _METHOD(__lc_ctype,iswctype) (c,cmsk,__lc_ctype))
#define _TOUPPER(c) ((int) ((_METHOD(__lc_ctype,towupper) == 0L) \
		? __lc_ctype->_upper[c] \
		: _METHOD(__lc_ctype,towupper) (c,__lc_ctype)))
#define _TOLOWER(c) ((int) ((_METHOD(__lc_ctype,towlower) == 0L) \
		? __lc_ctype->_lower[c] \
		: _METHOD(__lc_ctype,towlower) (c,__lc_ctype)))

#define _ISWMACRO(c,cmsk) ((_METHOD(__lc_ctype,iswctype) == 0L) \
		? (int) (__lc_ctype->_mask[(int)(c)] & (cmsk)) \
		: _METHOD(__lc_ctype,iswctype) (c,cmsk,__lc_ctype))
#define _TOWUPPER(c)	 ((_METHOD(__lc_ctype,towupper) == 0L) \
		? __lc_ctype->_upper[(int)(c)] \
		: _METHOD(__lc_ctype,towupper) (c,__lc_ctype))
#define _TOWLOWER(c)	 ((_METHOD(__lc_ctype,towlower) == 0L) \
		? __lc_ctype->_lower[(int)(c)] \
		: _METHOD(__lc_ctype,towlower) (c,__lc_ctype))

extern int __iswctype_sb __((wint_t, wctype_t, _LC_ctype_t *));
