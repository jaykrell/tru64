 ...
 */
/*	
 *	@(#)$RCSfile: wait.h,v $ $Revision: 4.2.23.2 $ (DEC) $Date: 1996/12/09 22:01:40 $
 */ 
/*
...
union wait;
extern pid_t wait4 __((pid_t, union wait *, int, struct rusage *));
_END_CPLUSPLUS
#endif  /* !_NO_PROTO */
#endif /* _OSF_SOURCE */
/*
 ...
 * NOTE: See above of _POSIX_C_SOURCE and _XOPEN_SOURCE defintion.
 */
