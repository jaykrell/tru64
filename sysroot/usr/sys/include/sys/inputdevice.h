 ...
 */
/*	
 *	@(#)$RCSfile: inputdevice.h,v $ $Revision: 4.2.31.2 $ (DEC) $Date: 1999/01/22 20:12:58 $
 */ 
/*
 */
/*
...
#define KBD_HOT_SWAP_TYPE	6	
#define MOUSE_HOT_SWAP_TYPE	7	
...
typedef struct {
	...
	unsigned char	device_type;	/* which type of device		*/
        unsigned char   type;		/* type of event (e.g. hotswap, motion) */
	union {
	    struct { 
...
#define KB_LK411	6	/* LK-layout PCXAL kecodes keyboard */

#define KB_PCXAL_SET2   7       /* PS/2 keyboard, running with scan set 2 */
#define KB_PCXAL_SET1   8       /* PS/2 keyboard, running with scan set 1 */
