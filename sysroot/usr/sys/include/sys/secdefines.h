 ...
 */
/*
 * @(#)$RCSfile: secdefines.h,v $ $Revision: 4.2.23.1 $ (DEC) $Date: 2002/01/29 21:19:47 $
 */
...
/*
 * SEC_NFS requires SEC_NET for now.
 */
#if	SEC_NFS && !SEC_NET
#undef	SEC_NFS
#endif
...
#define SEC_ACL_POSIX		    0
#define SEC_NCAV		    0
#define SEC_ACL			    0
#define SEC_MAC			    0
#define SEC_ILB			    0
#define SEC_ENCODINGS		    0
#define SEC_ARCH		    0
#define SEC_FSCHANGE		    0
#define SEC_PTY			    0
#define	SEC_SOCKET		    0
#define SEC_NFS			    0
#define SEC_NET			    0
