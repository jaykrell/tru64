 ...
 */
/*	
 *	@(#)$RCSfile: acct.h,v $ $Revision: 4.2.19.1 $ (DEC) $Date: 2000/09/15 14:55:44 $
 */ 
/*
...
#define AMEAN	0040		/* ac_mem is average, not integral */
				/* When 0(old version),
					ac_mem is KB*Seconds units. */
				/* When 1, ac_mem is in 8KB units. */
