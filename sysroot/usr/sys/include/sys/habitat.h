 ...
 */
/*	
 *      @(#)$RCSfile: habitat.h,v $ $Revision: 4.3.12.4 $ (DEC) $Date: 1995/01/25 18:51:07 $
 */ 
...
/* DLM -- Dist. Lock Manager habitat */
/* used in constructing the load module */
#define	DLM_HAB      		"DLM"
#define	DLMV11       		0x0101  /* 1.1 */
#define	DLMV11A      		"1.1"
#define	DLM_HAB_NO   		0x07000000
/* used in constructing the library */
#ifdef  H_DLM
#define	HABITAT_INDEX   	DLM_HAB_NO
#define	HABITAT_STD_CALL(x)	SYS_dlm_ ## x
#define	HABITAT_NSTD_CALL(x)	SYS_dlm_/**/x
#define	HABITAT_BASE		dlm_FIRST

#define	HABITAT_ID      	"@(#) habitat_id = dlm_10:1994"
#define	HABITAT_LABEL 		_DLM_habitat_id
...
/* CNX -- Cluster Connection Manager habitat */
/* used in constructing the load module */
#define	CNX_HAB      		"CNX"
#define	CNXV11       		0x0101  /* 1.1 */
#define	CNXV11A      		"1.1"
#define	CNX_HAB_NO   		0x08000000
/* used in constructing the library */
#ifdef  H_CNX
#define	HABITAT_INDEX   	CNX_HAB_NO
#define	HABITAT_STD_CALL(x)	SYS_cnx_ ## x
#define	HABITAT_NSTD_CALL(x)	SYS_cnx_/**/x
#define	HABITAT_BASE  		cnx_FIRST

#define	HABITAT_ID      	"@(#) habitat_id = cnx_10:1994"
#define	HABITAT_LABEL 		_CNX_habitat_id
