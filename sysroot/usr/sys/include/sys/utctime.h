 ...
 */
/*	
 *	@(#)$RCSfile: utctime.h,v $ $Revision: 4.2.17.1 $ (DEC) $Date:
92/11/30 16:53:41 $
 */ 
/*
 */
...
#include <sys/timemisc.h> /* for struct timespec */
# if !defined (_XOPEN_SOURCE) || (_XOPEN_SOURCE < 500)
#include <sys/signalmisc.h> /* These definitions are hidden in XSH5 Namespace */
