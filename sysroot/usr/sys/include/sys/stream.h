 ...
 */
/*
 * @(#)$RCSfile: stream.h,v $ $Revision: 4.2.34.1 $ (DEC) $Date: 2001/10/29 20:22:02 $
 */
/*
...
struct	qinit {
	...
	int	(*qi_srvp)(queue_t *);
	int	(*qi_qopen) __((int, char *));
	int	(*qi_qclose) __((int, char *));
	int	(*qi_qadmin)(void);
...
#define	M_HPDATA        0x8c	/* OSF-private: hi pri. data. NO LONGER USED */
...
#define SO_ISAPTM	0x80000	/* Master stream pty */
#endif
...
#ifdef	_KERNEL
/*
 * Provide u.u_error for System V drivers.
 */
#define u_error		u_tsd[TSD_STREAMS_KEY]
extern int strmsgsz;
#endif
