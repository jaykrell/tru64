 ...
 */
/*	
 *	@(#)$RCSfile: mode.h,v $ $Revision: 4.2.12.1 $ (DEC) $Date: 2002/03/20 20:41:15 $
 */ 
/*
 */
/*
 ...
 * standard specific values are present.  Since mode.h defines values on 
 * behalf of stat.h and since stat.h includes mode.h, this header adheres 
 * to the POSIX requirements.
 */
...
/*
 * A bit definition (in the upper 16 bits) for the mknod system call.
 */
#define S_VALIDATE	01000000		/* validate how to make the dsf */
