 ...
 */
/*	
 *	@(#)$RCSfile: addrconf.h,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1997/01/03 19:31:04 $
 */ 
/*
 */
/*
...
#define AC_STACK	3		/* default stack area */
...
#define AC_MMAP_STACK	13		/* thread stack */

#define AC_N_AREAS	14		/* number of known areas */
