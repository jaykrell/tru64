 ...
 */
/*	
 *	@(#)$RCSfile: lock_types.h,v $ $Revision: 4.2.6.2 $ (DEC) $Date: 1993/06/11 17:00:37 $
 */ 
/*
 */
/*
...
#define	LTYPE_SWINTR_LAST	(LTYPE_INTR_START + 1)

#define LTYPE_PROC_START        (LTYPE_SWINTR_LAST + 0)
#define LTYPE_PROCREL           (LTYPE_PROC_START + 1)
#define LTYPE_PGHASH            (LTYPE_PROC_START + 2)
#define LTYPE_PGRP              (LTYPE_PROC_START + 3)
#define LTYPE_UADDR             (LTYPE_PROC_START + 4)
#define LTYPE_PROC_LAST         (LTYPE_PROC_START + 4)
