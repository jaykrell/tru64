 ...
 */
/*	
 *	@(#)$RCSfile: reboot.h,v $ $Revision: 4.2.8.2 $ (DEC) $Date: 1996/11/01 16:50:54 $
 */ 
/*
 */
/*
...
#define RB_PARAM	0x100	/* is set, boot parameter file ok */
#define RB_DUMP		0x200	/* generate a crashdump on the way down */
#define RB_PANIC	0	/* reboot due to panic */
#define RB_BOOT		1	/* reboot due to boot() */
#define RB_POWERDOWN    0x400   /* do an o.s. system powerdown */
