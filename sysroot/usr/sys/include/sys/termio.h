 ...
 */
/*	
 *	@(#)$RCSfile: termio.h,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1996/10/04 14:21:46 $
 */ 
/*
 */
/*
...
#define VNOFLSH  0x8000		/*
				 ...
				 */
#define VCRTSCTS 0x80		/*
				 * The BSD equivilent is 0x10000 which is
				 * outside of the range for a short.
				 */
#else
...
#define CRTSCTS 0x80			/* RTS/CTS flow control. */
#endif /* _KERNEL */
