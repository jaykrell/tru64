 ...
 */
/*
 * @(#)$RCSfile: method.h,v $ $Revision: 1.1.15.2 $ (DEC) $Date: 2000/07/14 18:58:12 $
 */
/*
 ...
 */
#if !defined(__H_METHOD) && (!defined(__cplusplus) || defined(lint))
#define __H_METHOD
...
#define METH_LIBNAME(m) (std_methods[m].lib_name[method_class])

#endif  /* !__H_METHOD && !__cplusplus */
