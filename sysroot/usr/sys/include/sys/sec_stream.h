 ...
 */
/*	
 *	@(#)$RCSfile: sec_stream.h,v $ $Revision: 4.2.4.2 $ (DEC) $Date: 1995/06/30 22:39:29 $
 */ 
/*
 */
/*
...
#if	SEC_NET
/* Bitmask definitions for interfacing with trusted networking */
#include <sec/sec_tnmasks.h>
#else	/* SEC_NET */
/*
...
#if	SEC_NET
/* MLS+ secure networking attribute structure definition. */
#include <sec/sec_tnattrs.h>
#else	/* SEC_NET */
/*
