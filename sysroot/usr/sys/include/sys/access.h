 ...
 */
/*	
 *	@(#)$RCSfile: access.h,v $ $Revision: 4.2.7.2 $ (DEC) $Date: 1995/09/07 17:37:21 $
 */ 
/*
 */
/*
 ...
 * are required to be included by unistd.h when _POSIX_C_SOURCE is 
 * defined >= 1.  Therefore, these values are confined within POSIX checks.
 */
