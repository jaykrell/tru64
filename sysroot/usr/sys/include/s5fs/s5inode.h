 ...
 */
/*	
 *	@(#)$RCSfile: s5inode.h,v $ $Revision: 4.2.5.2 $ (DEC) $Date: 1999/02/01 20:31:37 $
 */ 
/*
 */
/*
...
extern struct lockinfo *s5in_lockinfo;
#define s5IN_LOCK_INIT(ip)	lock_setup(&(ip)->i_lock, s5in_lockinfo,TRUE);
