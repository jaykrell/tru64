 ...
 */
/*
 * @(#)$RCSfile: pfiltdefs.h,v $ $Revision: 1.1.12.1 $ (DEC) $Date: 2000/01/21 20:26:06 $
 */
/* Based on:
...
#ifdef __cplusplus
typedef	enum {xfalse, xtrue}	boolean;
#define	TRUE    ((int)xtrue)
#define	FALSE   ((int)xfalse)
#else
...
#ifndef _KERNEL
/* new style queue structure, found in <kern/queue.h> */
struct queue_entry {
...
struct enState
{
    ...
    boolean	ens_Attached;		/* has this device been removed? */
};
...
extern struct enOpenDescriptor	**enAllDescriptors;
extern int			*enUnitMap;
extern struct enet_info		*enet_info;
