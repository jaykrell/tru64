 ...
 */
/*
 * @(#)$RCSfile: ppp_mod.h,v $ $Revision: 1.1.4.3 $ (DEC) $Date: 1999/11/04 22:12:23 $
 */
/*
...
#define ALLOC_SLEEP(n)		(void *)malloc((u_long)(n), BUCKETP(n), M_PPP, M_WAITOK)
#define ALLOC_NOSLEEP(n)	(void *)malloc((u_long)(n), BUCKETP(n), M_PPP, M_NOWAIT)
#else
#define ALLOC_SLEEP(n)		(void *)malloc((u_long)(n), BUCKETINDEX(n), M_PPP, M_WAITOK)
#define ALLOC_NOSLEEP(n)	(void *)malloc((u_long)(n), BUCKETINDEX(n), M_PPP, M_NOWAIT)
#endif
...
#undef FREE
#endif
#define FREE(p, n)		free((void *)(p), M_PPP)
...
#include <sys/proc.h>
#define NOTSUSER()		PRIV_SUSER(u.u_cred, &u.u_acflag, SEC_REMOTE, EPERM, EPERM, error)

#include <net/net_globals.h>

#endif /* __osf__ */

/* for Digital UNIX locking stuff
 */
#ifndef NETSYNC_LOCK
...
#define OPEN_ERROR(x)		{ u.u_error = (void *)(x); return OPENFAIL; }
