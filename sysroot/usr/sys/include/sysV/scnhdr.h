 ...
 * HISTORY
 * $Log: scnhdr.h,v $
 * Revision 4.3.5.1  2003/06/19  13:26:41  Matthew_McGrath
 * 	Fix STYP_COMMENT, add STYP_EXTMASK.
 *
 * Revision 4.3.2.5  1992/12/09  15:02:04  Jay_Estabrook
 * 	Replace "LANGUAGE_C" with "__LANGUAGE_C__", which is standard.
 * 	[92/12/09  14:57:44  Jay_Estabrook]
 *
 * Revision 4.3.2.4  92/12/08  18:13:34  Ernie_Petrides
 * 	Clean up some kernel build warnings.
 * 	[92/12/08  15:21:17  Ernie_Petrides]
 * 
 * Revision 4.3.2.3  92/07/28  15:50:59  Jin_Chen
 * 	Deleted duplicate HISTORY log at end of the file
 * 	[92/07/28  15:50:06  Jin_Chen]
 * 
 * Revision 4.3.2.2  92/01/22  17:11:32  Anton_Verhulst
 * 	Fix SCNROUND definition to match the one in sys/exec.h to prevent
 * 	cpp redefinition warnings.
 * 	[92/01/22  17:10:45  Anton_Verhulst]
 * 
 * Revision 4.3  92/01/15  02:13:29  devbld_gsf
 * 	Baselevel alpha_bl002
 * 
 * Revision 4.2.2.3  91/12/09  16:05:32  Paul_Hansen
 * 	Fixed more inconsistencies between ag and alpha
 * 	[91/12/09  16:04:41  Paul_Hansen]
 * 
 * Revision 4.2.2.2  91/12/07  14:04:56  Paul_Hansen
 * 	merged tin-based Alpha vers
 * 	[91/12/07  14:04:14  Paul_Hansen]
 * 
 * Revision 4.2  91/09/19  23:04:55  devbld
 * 	Adding ODE Headers
 * 
 * $EndLog$
 */
...
/* | All Rights Reserved.                                  | */
/* --------------------------------------------------------- */
/* $Header: /share/buffer/build/rcs.dsk1/os/src/kernel/sysV/scnhdr.h,v 4.3.5.1 2003/06/19 13:26:41 Matthew_McGrath Exp $ */
#ifndef __SCNHDR_H
#define __SCNHDR_H
...
#define STYP_EXTMASK	16#0FF00000
