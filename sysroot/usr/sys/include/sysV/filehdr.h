 ...
 * HISTORY
 * $Log: filehdr.h,v $
 * Revision 4.3.12.2  2003/06/19  13:26:40  Matthew_McGrath
 * 	Add define for F_COMMENT.
 *
 * Revision 4.3.12.1  2003/01/06  20:29:13  Matthew_McGrath
 * 	Add define for F_WXALLOW.  [QAR 94136]
 *
 * Revision 4.3.5.2  1994/04/19  17:28:03  Anton_Verhulst
 * 	Synch up with ./src/include/alpha/filehdr.h.
 * 	[1994/04/18  17:58:40  Anton_Verhulst]
 *
 * Revision 4.3.3.2  1992/12/09  15:01:57  Jay_Estabrook
 * 	Replace "LANGUAGE_C" with "__LANGUAGE_C__", which is standard.
 * 	[92/12/09  14:57:36  Jay_Estabrook]
 * 
 * Revision 4.3  92/01/15  02:13:25  devbld_gsf
 * 	Baselevel alpha_bl002
 * 
 * Revision 4.2.2.2  91/12/07  14:00:28  Paul_Hansen
 * 	merged tin-based Alpha vers
 * 	[91/12/07  13:59:53  Paul_Hansen]
 * 
 * Revision 4.2  91/09/19  23:04:58  devbld
 * 	Adding ODE Headers
 * 
 * $EndLog$
 */
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /share/buffer/build/rcs.dsk1/os/src/kernel/sysV/filehdr.h,v 4.3.12.2 2003/06/19 13:26:40 Matthew_McGrath Exp $ */
#ifndef _FILEHDR_H
#define _FILEHDR_H
...
#if defined(__mips64) || defined(__alpha)
      f_symptr : integer64;		/* file pointer to symbolic header   */
#else
 ...
 */
#if defined(__LANGUAGE_C__) || defined(__cplusplus)
#define F_MIPS_SHARE_MASK   030000
...
#define F_MIPS_NO_REMOVE    0100000       /* won't remove nops */
#endif
#ifdef __LANGUAGE_PASCAL__
#define F_MIPS_SHARE_MASK   16#03000
...
#define F_MIPS_NO_REMOVE    16#08000
#endif
