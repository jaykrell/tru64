 ...
 */
/*	
 *	@(#)$RCSfile: inet_config.h,v $ $Revision: 4.2.9.1 $ (DEC) $Date: 1999/12/01 20:10:08 $
 */ 
/*
 */
/*
...
#define IPQMAX 64	        /* Size of ipintrqs[] and ip6intrqs[] */
...
typedef struct inet_config {
	...
	u_int	tcp_sendspace;		/* Default send queue (32768) */
	u_int	tcp_recvspace;		/* Default receive queue (32768) */

	int	udpttl;			/* Default time to live (30) */
	int	udpcksum;		/* Enable checksumming (1) */
	u_int	udp_sendspace;		/* Default send queue (9216) */
	u_int	udp_recvspace;		/* Default receive queue (41600) */
