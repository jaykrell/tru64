 ...
 */
/*
 * @(#)$RCSfile: lk201.h,v $ $Revision: 1.1.6.7 $ (DEC) $Date: 1998/07/29 20:54:19 $
 */
/*
 ...
 * function protos
 */
extern void scc_enable_keyboard(void);

extern int lk201_register_device(struct controller *ctlr);
extern int lk201_register_kbd_ehm(struct controller *ctlr);
extern int lk201_getc(u_int data);
extern int lk201_putc(char c);
extern caddr_t lk201_init_closure(caddr_t address);
extern void lk201_up_down_mode(ws_keyboard_state *lp);
extern void lk201_reset_keyboard(ws_keyboard_state *lp);
extern void lk201_ring_bell(caddr_t closure);
extern int lk201_set_keyboard_control(caddr_t closure, ws_keyboard *kp, 
				      ws_keyboard_control *wskp);
extern void lk201_keyboard_event(caddr_t closure, ws_event_queue *queue, 
				 register int ch);
extern void lk201_keyboard_char(ws_keyboard_state *lp, u_short data);
extern void lk201_set_leds(ws_keyboard_state *lp);
extern void lk201_update_ehm_attrs(ulong args);
#endif /* _KERNEL */
