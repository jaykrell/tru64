 ...
 */
/*	
 *	@(#)$RCSfile: bt463.h,v $ $Revision: 1.2.17.2 $ (DEC) $Date: 1999/04/05 11:41:00 $
 */ 
/*
 */
/*
...
extern int bt463_init_color_map(caddr_t closure);
extern int bt463_load_color_map_entry(caddr_t closure, int map, 
				      register ws_color_cell *entry);
extern int bt463_video_on(caddr_t closure);
extern int bt463_video_off(caddr_t closure);
extern void bt463_clean_colormap(caddr_t closure);
extern int bt463_recolor_cursor(caddr_t closure, 
 ...
 */
extern int bt463_2_init(caddr_t closure);
extern int bt463_2_clean_cursormap(caddr_t closure);

extern int bt463_2_init_color_map(caddr_t closure);
extern int bt463_2_load_color_map_entry(caddr_t closure, int map, 
					register ws_color_cell *entry);
extern void bt463_2_clean_colormap(caddr_t closure);
extern int bt463_2_recolor_cursor(caddr_t closure, 
				  ws_screen_descriptor *screen, 
				  ws_color_cell *fg, ws_color_cell *bg);
extern void bt463_2_load_wid(struct bt463info2 *bti, int index, int count, 
			     Bt463_Wid_Cell *data);

extern int bt463_clean_cursormap(caddr_t closure);
