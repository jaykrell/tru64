 ...
 */
/*
 * @(#)$RCSfile: amd79c30_reg.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1997/04/10 21:42:53 $
 */
...
#define DMA_CUR_XMT 		PHYS_TO_KSEG ((unsigned long) (bba_tc_reg_p + (0x80<<1))) /* Current transmit pointer*/
#define DMA_NEXT_XMT 		PHYS_TO_KSEG ((unsigned long)bba_tc_reg_p + (0x90<<1)) /* Next transmit pointer	*/
#define DMA_CUR_RCV 		PHYS_TO_KSEG ((unsigned long)bba_tc_reg_p + (0xa0<<1)) /* Current receive pointer */
#define DMA_NEXT_RCV 		PHYS_TO_KSEG ((unsigned long)bba_tc_reg_p + (0xb0<<1)) /* Next receive pointer	*/
