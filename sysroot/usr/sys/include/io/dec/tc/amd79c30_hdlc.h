 ...
 */
/*
 * @(#)$RCSfile: amd79c30_hdlc.h,v $ $Revision: 1.1.9.2 $ (DEC) $Date: 1997/06/24 13:50:25 $
...
struct hdlc_info {
	...
	int chan;		/* Channel number, for stats		*/
	unsigned char *base;	/* Base of this buffer			*/
};

typedef struct hdlc_debug {
	int in_flags;
	int in_flags_seq;
	int frame_abort;
	int frame_complete;
...
extern hdlc_debug_t hdlc_bba_stats[2];
...
#define HDLC_MAX_BUF		1576		/* Input-Buffer-Size	*/
