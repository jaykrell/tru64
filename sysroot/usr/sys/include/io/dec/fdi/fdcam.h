 ...
 */
/*
#pragma ident "@(#)$RCSfile: fdcam.h,v $ $Revision: 1.1.48.1 $ (DEC) $Date: 2000/10/24 23:53:48 $"
*/
...
#define FDI_DMA_BIT        0x001
#define FDI_RESULT_BIT     0x002
#define FDI_VERIFY_BIT     0x004
#define FDI_VCMP_BIT       0x008
#define FDI_VDUMP_BIT      0x010
#define FDI_IOTRC_BIT      0x020
 ...
 *  Globals for locks
 */
extern struct lockinfo *fdi_lockinfo;

/* lock definitions */
#define FDI_LOCK(x)             simple_lock(&(x))
#define FDI_UNLOCK(x)           simple_unlock(&(x))
#define FDI_LOCK_INIT(x) simple_lock_setup(&(x), fdi_lockinfo)
...
void fdcam_intr(void);
int fdcam_port_is_free(struct fdcam_status_block*);
void fdcam_diag_f(int);
