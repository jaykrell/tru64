 ...
 */
/*
 * @(#)$RCSfile: srvc.h,v $ $Revision: 1.1.8.4 $ (DEC) $Date: 1996/07/25 12:34:55 $
 */
...
#else
   U32		srvc_flags;		/* Service flags */
   U32		srvc_flags2;		/* atleast stay aligned */
#endif
...
#define	SRVC_RESERVED  	0x0000000080000000	/* Reserved for compatibility */
#define	SRVC_ERROR   	0x8000000000000000      /* Error and errno is valid. */
#else
#define	STR_MSG_VALID	0x00000001		/* String area valid. */
#define	SRVC_ERROR   	0x80000000		/* Error and errno is valid. */
#endif
