...
/*	
 *	@(#)$RCSfile: devio.h,v $ $Revision: 1.1.32.7 $ (DEC) $Date: 1999/01/18 22:39:01 $
 */ 
/*
 */
/*
...
#define DEV_PCI		0x0D		/* PCI bus			*/
#define DEV_TC		0x0E		/* TC bus			*/
...
#define DEV_IDE_GEN	"EIDE"		/* IDE generic string		*/
...
#define DEV_RRDxx	"RRDxx" 	/* Unknown SCSI cd drive	*/
...
#define DEV_RRD45	"RRD45"		/* RRD45 disk controller	*/
#define DEV_RRD46	"RRD46"		/* RRD46 disk controller	*/
...
#define DEV_SWXCR	"SWXCR"		/* SWXCR RAID Array Controller  */
...
#define DEV_RE		"RE"		/* SWXCR RAID disk drive	*/
...
#define DEV_RZ25F	"RZ25F"		/* RZ25F disk drive		*/
#define DEV_RZ25L	"RZ25L"		/* RZ25L disk drive		*/
#define DEV_RZ25M	"RZ25M"		/* RZ25M disk drive		*/
#define DEV_RZ26	"RZ26"		/* RZ26 disk drive		*/
#define DEV_RZ26B	"RZ26B"		/* RZ26B disk drive		*/
#define DEV_RZ26F	"RZ26F"		/* RZ26F disk drive		*/
#define DEV_RZ26J	"RZ26J"		/* RZ26J disk drive		*/
#define DEV_RZ26L	"RZ26L"		/* RZ26L disk drive		*/
#define DEV_RZ26M	"RZ26M"		/* RZ26M disk drive		*/
#define DEV_RZ26N	"RZ26N"		/* RZ26N disk drive		*/
#define DEV_RZ27	"RZ27"		/* RZ27 disk drive		*/
#define DEV_RZ28	"RZ28"		/* RZ28 disk drive		*/
#define DEV_RZ28B	"RZ28B"		/* RZ28B disk drive		*/
#define DEV_RZ28D	"RZ28D"		/* RZ28D disk drive		*/
#define DEV_RZ28J	"RZ28J"		/* RZ28J disk drive		*/
#define DEV_RZ28L	"RZ28L"		/* RZ28L disk drive		*/
#define DEV_RZ28M	"RZ28M"		/* RZ28M disk drive		*/
#define DEV_RZ29	"RZ29"		/* RZ29 disk drive		*/
#define DEV_RZ29B	"RZ29B"		/* RZ29B disk drive		*/
#define DEV_RZ29L	"RZ29L"		/* RZ29L disk drive		*/
#define DEV_RZ29M	"RZ29M"		/* RZ29M disk drive		*/
...
#define DEV_RZ59	"RZ59"		/* RZ59 disk drive		*/
...
#define DEV_TLZ09       "TLZ09"         /* TLZ09 tape drive             */
#define DEV_TLZ9        "TLZ9"          /* TLZ09 with loader tape drive */
...
#define DEV_TZ885       "TZ885"         /* TZ885 with loader tape drive */
#define DEV_TZ887       "TZ887"         /* TZ887 with loader tape drive */
...
#define DEV_TZK13	"TZK13"		/* TZK13 QIC format tape	*/
#define DEV_TZK20	"TZK20"		/* TZK20 QIC format tape	*/
...
#define DEV_TAPE_MARK	0x2000		/* A tape mark has been detected
					 * on a read                    */
#define DEV_SHORT_REC	0x4000		/* Record Read is smaller than
					 * user read request            */
#define DEV_TPMRK_PEND	0x8000		/* Tape Mark read but not
					 * yet reported to user         */
#define DEV_REWINDING	0x10000		/* Unit is rewinding            */
#define DEV_READ_OPP	0x20000		/* Reading in reverse direction */
#define DEV_BOOT	0x40000		/* Boot support		*/
...
#define DEV_81630_BPI	0x1000000	/* TZ88 tape density     	*/
...
typedef union devgeom {
	...
	unsigned long   sector_size; /* Number of bytes in sector/block/lbn   */
	unsigned long	min_trans;  /* Min # of bytes for transfer size	      */
	unsigned long	max_trans;  /* Max # of bytes for transfer size       */
	unsigned long   prefer_trans; /* Preferred # of bytes for transfer size */
	/* new fields */
    ...
    unsigned char	pad[108];  /* Allocate space to allow for expansion */	
} DEVGEOMST;
...
#define DEVGEOM_INVENTED 0x04	/* Geometry not supplied one made up */
