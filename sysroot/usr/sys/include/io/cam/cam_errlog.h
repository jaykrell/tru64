 ...
 */
/*
 * @(#)$RCSfile: cam_errlog.h,v $ $Revision: 1.1.7.2 $ (DEC) $Date: 1997/10/07 16:59:29 $
 */
#ifndef _CAM_ERRLOG_
#define _CAM_ERRLOG_
...
#   define CAM3_ERROR( FUNC, MSGSTR, EFLAGS, ARG4, TRANS, ARG6)            \
    {                                                                    \
	/* VARARGS */                                                    \
	(void)(*local_errlog)( TRANS, FUNC, MSGSTR, EFLAGS, ARG4, ARG6 ); \
    }
