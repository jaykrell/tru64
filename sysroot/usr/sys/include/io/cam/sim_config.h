 ...
 */
/*
 * @(#)$RCSfile: sim_config.h,v $ $Revision: 1.1.8.2 $ (DEC) $Date: 1999/04/02 20:16:03 $
 */
...
#define	INIT_CAM_HBA_LIMIT	32		/* # of sim drv. tbl. ent. */
#define	INIT_CAM_DME_LIMIT	32		/* # of sim drv. tbl. ent. */
