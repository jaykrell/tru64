 ...
 */
/*
 * @(#)$RCSfile: sim_target.h,v $ $Revision: 1.1.14.2 $ (DEC) $Date: 1999/02/25 20:28:54 $
 */
#ifndef _SIM_TARGET_
#define _SIM_TARGET_
...
#define TARG_DISCONNECT	 0x00000008	/* Set we need to disconnect ASAP */
/*
 * Information for the default data used for the inquiry command.
 */
#define TARG_VENDOR_ID		"Tru64   "
