 ...
 */
/*
 * @(#)$RCSfile: dme.h,v $ $Revision: 1.1.11.3 $ (DEC) $Date: 1999/06/17 21:13:58 $
 */
#ifndef _DME_INCL_
#define _DME_INCL_
...
#define DME_CLEAR(softc,dme_desc)((softc)->dme->vector.dme_clear((dme_desc)))
...
#define HBA_DME_CONTROL_VERS 1
	...
	void (*dme_copyin)();	/* data in xfer with buffer		*/
	void (*dme_copyout)();	/* data out xfer with buffer		*/
	void (*dme_clear)();	/* clear the buffer			*/
...
#define DME_DMA_ACTIVE	0x0200  /* This descriptor is involved in DMA	  */
				/*   Not all SIMs use this ACTIVE bit	  */
