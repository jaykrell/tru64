 ...
 */
/*
 * @(#)$RCSfile: sim_94.h,v $ $Revision: 1.1.23.5 $ (DEC) $Date: 1997/10/02 21:40:14 $
 */
#ifndef _SIM_94_
#define _SIM_94_
...
#define SIM94_CNF2_FE		0x40	/* Enable latch and 24 bit mode */
...
#define sim94_tchsb	w.w_xcntvh.reg	/* transfer count HSB		*/
...
#define TC_DRVR_UNCONFIGURED           0
#define TC_DRVR_CONFIG_STAT            1
#define TC_DRVR_CONFIG_DYNAM           2

/*
 * defines for the tcds & asc bus structures. Hold resources
 * allocated by sim94_probe and passed to sim94_attach.
 */

#define adpt_sim94         private[0]  /* sim94 softc structure */
#define adpt_hid           private[1]  /* Interrupt handler ID */
#define adpt_addr          private[2]  /* */
#define adpt_addr2         private[3]  /* temporary SIM_WS pointer */
#define adpt_physaddr      private[4]  /* ASC or TCDS base CSR addr */
#define adpt_physaddr2     private[5]
