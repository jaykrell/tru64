 ...
 */
/*
 * @(#)$RCSfile: scsi_rodirect.h,v $ $Revision: 1.1.14.1 $ (DEC) $Date: 2001/09/17 17:43:38 $
 */
...
#define RODIR_READ_FORMAT_CAPACITIES		0x23
...
/*
 * CD-ROM Read TOC (SCSI-3) Command Descriptor Block:
 */
typedef struct CdReadTOC_S3_CDB {
	u_char	opcode;			/* Operation Code.		[0] */
	u_char		: 1,		/* Reserved.			[1] */
		msf	: 1,		/* Report address in MSF format.    */
			: 3,		/* Reserved.			    */
	...
	u_char	link	: 1,		/* Link.			[9] */
		flag	: 1,		/* Flag.			    */
			: 4,		/* Reserved.			    */
		vendor	: 2;		/* Vendor Unique.		    */
} RODIR_READ_TOC_S3_CDB;

/* ---------------------------------------------------------------------- */

/*
 * CD-ROM Read TOC (modified SCSI-2) Command Descriptor Block:
 */
typedef struct CdReadTOC_S2_CDB {
	u_char	opcode;			/* Operation Code.		[0] */
	u_char		: 1,		/* Reserved.			[1] */
		msf	: 1,		/* Report address in MSF format.    */
			: 3,		/* Reserved.			    */
	...
	u_char	link	: 1,		/* Link.			[9] */
		flag	: 1,		/* Flag.			    */
			: 4,		/* Reserved.			    */
		format	: 2;		/* Microsoft style format bits.	    */
} RODIR_READ_TOC_S2_CDB;
 ...
 */
typedef struct CdReadFormatCapacities_CDB {
	u_char	opcode;			/* Operation Code.		[0] */
	u_char		:5,		/* Reserved.			[1] */
		lun	:3;		/* Logical Unit number		    */
	u_char	reserved[5];		/* Reserved.		      [2-6] */
	u_char	alloc_len1;		/* Allocation length (MSB).	[7] */
	u_char	alloc_len0;		/* Allocation length (LSB).	[8] */
	u_char	link	: 1,		/* Link.			[9] */
		flag	: 1,		/* Flag.			    */
			: 4,		/* Reserved.			    */
		vendor	: 2;		/* Vendor Unique.		    */
} RODIR_READ_FORMAT_CAPACITIES_CDB;
