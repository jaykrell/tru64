 ...
 */
/*
 * @(#)$RCSfile: tcds_adapt.h,v $ $Revision: 1.1.13.2 $ (DEC) $Date: 1996/12/18 15:47:29 $
 */
...
typedef struct tcds_asic {
    ...
    PAD_U32 ids;
    PAD_U32 flash_1[0x100 - 0x3];
    PAD_U32 flash_fw[0x8];	/* 8 chars firmware version */
    PAD_U32 flash_vid[0x8];	/* 8 chars Vendor Id        */
    PAD_U32 flash_rest[0x10000 - 0x110]; /* the rest of Flash EEPROM */
    TCDS_DMA dma;
