 ...
 */
/*
 * @(#)$RCSfile: i2outil.h,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1998/10/02 15:29:16 $
 */
...
#if !defined(_I2O_UTILITY_HDR_)
#define _I2O_UTILITY_HDR_
 ...
 * -- compiler aligns structs on 64-bit alignment,
