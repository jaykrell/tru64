 ...
 */
/*
 * @(#)$RCSfile: i2oadptr.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1998/05/11 22:17:25 $
 */
...
#if !defined(_I2O_ADPTR_HDR_)
#define _I2O_ADPTR_HDR_
 ...
 * -- compiler aligns structs to 64-bit alignment, which
 *    meats I2O's (32-bit) alignment requirement.
 *
 * PRAGMA_ALIGN_PUSH
 *
 * PRAGMA_PACK_PUSH
