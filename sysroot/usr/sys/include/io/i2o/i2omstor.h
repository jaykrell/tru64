 ...
 */
/*
 * @(#)$RCSfile: i2omstor.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1998/05/11 22:17:40 $
 */
...
#if !defined(_I2O_MSTOR_HDR_)
#define _I2O_MSTOR_HDR_
...
/*****************************************************************************
 *
 *    I2OMStor.h -- I2O Random Block Storage Devices Class Message file
 *
 ...
 * -- compiler aligns structs on 64-bit alignemnt,
