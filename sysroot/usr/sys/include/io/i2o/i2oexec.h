 ...
 */
/*
 * @(#)$RCSfile: i2oexec.h,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1998/10/02 15:29:05 $
 */
...
#if !defined(_I2O_EXECUTIVE_HDR_)
#define _I2O_EXECUTIVE_HDR_

#define I2OEXEC_REV 1_5_5  /* I2OExec header file revision string */

#include <io/i2o/i2omsg.h>      /* Include the Base Message file */
#include <io/i2o/i2outil.h>
 ...
 *    Functions that both send and receive data can be either but 
 *    an attempt is made to use the function number that indicates 
 *    the greater transfer amount.
...
/* Not used in D-UNIX I2O;
 * -- compiler aligns structs on 64-bit alignments,
 *    which meets I2O (32-bit) alignment requirements.
 *
 * PRAGMA_ALIGN_PUSH
 * PRAGMA_PACK_PUSH
 */
...
#define    I2O_EVENT_CONNECTION_FAIL_RESPOND_NORMAL    0x00000000
#define    I2O_EVENT_CONNECTION_FAIL_NOT_REPONDING     0x00000001
#define    I2O_EVENT_CONNECTION_FAIL_NOT_RESPONDING    0x00000001
...
/* Digital Note: NOT UP TO V1.5 SPEC */
...
#define I2O_EXEC_FAILURE 0
#define I2O_EXEC_SUCCESS 1
#define I2O_INVALID_MFA 0xFFFFFFFF

#endif        /* _I2O_EXECUTIVE_HDR_ */
