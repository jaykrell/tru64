 ...
 */
/*
 * @(#)$RCSfile: i2obscsi.h,v $ $Revision: 1.1.4.2 $ (DEC) $Date: 1998/05/11 22:17:26 $
 */
...
#if !defined(_I2O_BASE_SCSI_HDR_)
#define _I2O_BASE_SCSI_HDR_
 ...
 * -- compiler aligns structs to 64-bit alignment,
 *    which meets I2O (32-bit) alignment requirement.
 *
 * PRAGMA_ALIGN_PUSH
 *
 * PRAGMA_PACK_PUSH
