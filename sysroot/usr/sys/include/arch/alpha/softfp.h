...
/***************************************************************
 *
 * prototypes for functions defined in softfp.c
 *
 ***************************************************************/

#if defined (__LANGUAGE_C__) || defined(__cplusplus)
int fp_infinity (unsigned long *, unsigned long *, unsigned long *, int, unsigned long *);
#endif
/*
...
#define SQRTSM		0x4b
#define SQRTSD		0xcb
#define SQRTSUM		0x14b
#define SQRTSUD		0x1cb
#define SQRTSSUM	0x54b
#define SQRTSSUD	0x5cb
#define SQRTSSUIM	0x74b
#define SQRTSSUID	0x7cb
#define SQRTTM		0x6b
#define SQRTTD		0xeb
#define SQRTTUM		0x16b
#define SQRTTUD		0x1eb
#define SQRTTSUM	0x56b
#define SQRTTSUD	0x5eb
#define SQRTTSUIM	0x76b
#define SQRTTSUID	0x7eb
