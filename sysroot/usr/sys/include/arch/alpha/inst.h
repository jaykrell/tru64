...
#define op_fltm         0x14            /* miscellaneous floating instructions */
#define op_opc14        0x14            /* for compatibilty */
...
#define op_misc		0x18		/* miscellaneous group */
...
#define AMASK_FIX          0x2          /* sqrt and f <-> i conversions extension     */
...
#define AMASK_PRECISE      0x200        /* Precise arithmetic traps */
					/* MV_TODOf: ECO 122 adds SIMD <11> */
#define AMASK_LOCKPFTCHOK  0x1000       /* Safe to prefetch lock cache block */
#define AMASK_BIT0_BWLS	   0x1	        /* byte/word load & store - deprecated definition */
...
/*
 * op_intmisc: miscellaneous integer group. These instructions are
 * operate format (o_format or l_format) instructions with the
 * function code encoded in the 7-bit 'function' field.
 */
...
/*
 * op_fltm: miscellaneous floating point group. These instructions are
 * floating point operate format (f_format) instructions with the function
 * code encoded in the 11-bit 'function' field.
 */

#define fltm_itofs      0x004
#define fltm_itoff      0x014
#define fltm_itoft      0x024

#define fltm_sqrts      0x08b
#define fltm_sqrtsc     0x00b
#define fltm_sqrtsm     0x04b
#define fltm_sqrtsd     0x0cb
#define fltm_sqrtsu     0x18b
#define fltm_sqrtsuc    0x10b
#define fltm_sqrtsum    0x14b
#define fltm_sqrtsud    0x1cb
#define fltm_sqrtssu    0x58b
#define fltm_sqrtssuc   0x50b
#define fltm_sqrtssum   0x54b
#define fltm_sqrtssud   0x5cb
#define fltm_sqrtssui   0x78b
#define fltm_sqrtssuic  0x70b
#define fltm_sqrtssuim  0x74b
#define fltm_sqrtssuid  0x7cb

#define fltm_sqrtt      0x0ab
#define fltm_sqrttc     0x02b
#define fltm_sqrttm     0x06b
#define fltm_sqrttd     0x0eb
#define fltm_sqrttu     0x1ab
#define fltm_sqrttuc    0x12b
#define fltm_sqrttum    0x16b
#define fltm_sqrttud    0x1eb
#define fltm_sqrttsu    0x5ab
#define fltm_sqrttsuc   0x52b
#define fltm_sqrttsum   0x56b
#define fltm_sqrttsud   0x5eb
#define fltm_sqrttsui   0x7ab
#define fltm_sqrttsuic  0x72b
#define fltm_sqrttsuim  0x76b
#define fltm_sqrttsuid  0x7eb

#define fltm_sqrtf      0x08a
#define fltm_sqrtfc     0x00a
#define fltm_sqrtfu     0x18a
#define fltm_sqrtfuc    0x10a
#define fltm_sqrtfs     0x48a
#define fltm_sqrtfsc    0x40a
#define fltm_sqrtfsu    0x58a
#define fltm_sqrtfsuc   0x50a

#define fltm_sqrtg      0x0aa
#define fltm_sqrtgc     0x02a
#define fltm_sqrtgu     0x1aa
#define fltm_sqrtguc    0x12a
#define fltm_sqrtgs     0x4aa
#define fltm_sqrtgsc    0x42a
#define fltm_sqrtgsu    0x5aa
#define fltm_sqrtgsuc   0x52a
