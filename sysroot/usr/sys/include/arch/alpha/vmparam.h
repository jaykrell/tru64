...
#ifndef	DFLSSIZ
#define	DFLSSIZ		(1<<23)		/* initial stack size limit */
#endif
...
/*
 * Define the bits per byte and bits per quad for upper level VM.
 */
...
/*
 * This is defined here to avoid include <machine/pmap.h> in vm_page.h
 */
#define PVH_SIZE 32	/* sizeof(union pv_list_head) */
