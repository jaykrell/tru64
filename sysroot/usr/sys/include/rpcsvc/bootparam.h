 ...
 */
/*
 * @(#)$RCSfile: bootparam.h,v $ $Revision: 1.1.3.2 $ (DEC) $Date: 1992/03/18 18:35:33 $
 */
/*	@(#)bootparam.h	1.4 90/07/19 4.1NFSSRC SMI	*/
...
typedef struct bp_ip_addr_t bp_ip_addr_t;


struct bp_address {
	int address_type;
	union {
		bp_ip_addr_t ip_addr;
	} bp_address;
};
